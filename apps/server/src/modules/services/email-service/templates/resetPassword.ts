...
const ResetPasswordEmail = (
    data: ResetPasswordEmailParams,
) => {
    const TextBody = `Your reset password link for oneworld`;
    const Subject = `Your reset password link for oneworld`;
    ...
    <tr>
    <td class="pad">
    <h1 style="margin: 0; color: #120c80; direction: ltr; font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 24px; font-weight: 400; letter-spacing: normal; line-height: 120%; text-align: left; margin-top: 0; margin-bottom: 0;">Forgot your password?<br/></h1>
    </td>
    </tr>
    </table>
    ...
    <p style="margin: 0;">Oops! We heard you lost your password. If you really did, click the button below to change your password:</p>
    </div>
    </td>
    </tr>
    </table>
    ...
    <tr>
    <td class="pad">
    <div align="left" class="alignment"><!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" style="height:48px;width:182px;v-text-anchor:middle;" arcsize="125%" stroke="false" fillcolor="#120c80"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:Arial, sans-serif; font-size:16px"><![endif]-->
    <a href="${CLIENT_URL}/user/reset-password?token=${data.token}"><div style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#120c80;border-radius:60px;width:auto;border-top:0px solid transparent;font-weight:400;border-right:0px solid transparent;border-bottom:0px solid transparent;border-left:0px solid transparent;padding-top:8px;padding-bottom:8px;font-family:'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;text-align:center;mso-border-alt:none;word-break:keep-all;"><span style="padding-left:25px;padding-right:25px;font-size:16px;display:inline-block;letter-spacing:normal;"><span style="word-break: break-word; line-height: 32px;">Change Password</span></span></div><!--[if mso]></center></v:textbox></v:roundrect><![endif]--></a>
    </div>
    </td>
    </tr>
    </table>
    ...
    <tr>
    <td class="pad">
    <div style="color:#120c80;direction:ltr;font-family:'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:150%;text-align:left;mso-line-height-alt:24px;">
    <p style="margin: 0;">Or, paste this link into your browser: <a href="${CLIENT_URL}/user/reset-password?token=${data.token}" rel="noopener" style="text-decoration: underline; color: #7747FF;" target="_blank">${CLIENT_URL}/user/reset-password?token=${data.token}</a></p>
    </div>
    </td>
    </tr>
    </table>
    ...
    <td class="pad">
    <div style="color:#120c80;direction:ltr;font-family:'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
    <p style="margin: 0;">If you didn’t request this, you can ignore this email. Your password won’t change until you create a new password.</p>
    </div>
    </td>
    </tr>
    </table>
